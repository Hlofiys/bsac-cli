...
pub struct GetScheduleForOneGroupListServiceResponse {
    ...
    pub data: Option<Option<Vec<models::GetScheduleForOneGroup>>>,
...
impl GetScheduleForOneGroupListServiceResponse {
    pub fn new() -> GetScheduleForOneGroupListServiceResponse {
