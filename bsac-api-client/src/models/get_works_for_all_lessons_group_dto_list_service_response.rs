...
pub struct GetWorksForAllLessonsGroupDtoListServiceResponse {
    ...
    pub data: Option<Option<Vec<models::GetWorksForAllLessonsGroupDto>>>,
...
impl GetWorksForAllLessonsGroupDtoListServiceResponse {
    pub fn new() -> GetWorksForAllLessonsGroupDtoListServiceResponse {
