...
pub struct GetLessonTasksDtoServiceResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::GetLessonTasksDto>>,
...
impl GetLessonTasksDtoServiceResponse {
    pub fn new() -> GetLessonTasksDtoServiceResponse {
