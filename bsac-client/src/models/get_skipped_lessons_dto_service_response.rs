...
pub struct GetSkippedLessonsDtoServiceResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::GetSkippedLessonsDto>>,
...
impl GetSkippedLessonsDtoServiceResponse {
    pub fn new() -> GetSkippedLessonsDtoServiceResponse {
