...
pub struct LessonScheduleServiceResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::LessonSchedule>>,
...
impl LessonScheduleServiceResponse {
    pub fn new() -> LessonScheduleServiceResponse {
