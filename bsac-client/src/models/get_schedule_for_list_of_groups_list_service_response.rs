...
pub struct GetScheduleForListOfGroupsListServiceResponse {
    ...
    pub data: Option<Option<Vec<models::GetScheduleForListOfGroups>>>,
...
impl GetScheduleForListOfGroupsListServiceResponse {
    pub fn new() -> GetScheduleForListOfGroupsListServiceResponse {
